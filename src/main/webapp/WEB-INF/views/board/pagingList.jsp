    ...
    <table class="table">
        ...
        <c:forEach items="${boardList}" var="board">
            <tr>
                ...
                <td><a href="/member/detail?page${paging.page}&id=${board.id}">${board.boardTitle}</a></td>
...
<div class="container">
    <ul class="pagination justify-content-center">
        ...
        <c:choose> <%-- else if문과 같음 --%>
            ...
            <c:otherwise>
                <li class="page-item">
                    <a class="page-link" href="/member/paging?page=${paging}">[이전]</a>
                </li>
            </c:otherwise>
        </c:choose>
        ...
        <c:choose>
            ...
            <%-- 마지막페이지가 아닌 경우에는 [다음]을 클릭하면 핸재페이지보다 1 큰 페이지 요청 --%>
            <c:otherwise>
                <li class="page-item">
